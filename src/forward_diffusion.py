...
def forward_diffusion(x0: torch.Tensor,
                      ...
                      alphas_bar_one_minus_sqrt: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    variance_for_timestep = get_value_and_reshape(alphas_bar_one_minus_sqrt, timestep, sample_shape)
